...
//
//ISTRUZIONI http://www.business-to-technology.com/generalized-hough-transform/instructions.html
//
...
int main(int argc, char* argv[]){
	...
	if(template_f){
		printf( "Running template function...\n" );
		runGHT('c');
	}

	if(algorithm_f){
		printf( "Running algorithm function...\n" );
		runGHT('r');
	}
